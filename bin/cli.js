...
import { cliopts, namespacedOptions } from '../node_modules/percollate/src/cli-opts.js';
import { pdf, epub, html, md } from '../src/index.js';

const { command, opts, operands } = cliopts(process.argv.slice(2));

const pkg = JSON.parse(
	readFileSync(new URL('../node_modules/percollate/package.json', import.meta.url))
);
